...
int VersusVaryingWidths_VaryingPointMass(std::string histogramFile){
    ...
    //m300 mass points
    histFileName = "run_XHH_bbtt_m300_hadhad_01p_5BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m300_hadhad_02p_5BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m300_hadhad_03p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    histFileName = "run_XHH_bbtt_m500_hadhad_01p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m500Histo01p = (TH1D*)histFile->Get(histogramFile.c_str());
    m500Histo01p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m500_hadhad_02p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m500Histo02p = (TH1D*)histFile->Get(histogramFile.c_str());
    m500Histo02p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m500_hadhad_03p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    //m1000 mass points
    histFileName = "run_XHH_bbtt_m1000_hadhad_01p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m1000Histo01p = (TH1D*)histFile->Get(histogramFile.c_str());
    m1000Histo01p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m1000_hadhad_02p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m1000Histo02p = (TH1D*)histFile->Get(histogramFile.c_str());
    m1000Histo02p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m1000_hadhad_03p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    //m1500 mass points
    histFileName = "run_XHH_bbtt_m1500_hadhad_01p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m1500Histo01p = (TH1D*)histFile->Get(histogramFile.c_str());
    m1500Histo01p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m1500_hadhad_02p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m1500Histo02p = (TH1D*)histFile->Get(histogramFile.c_str());
    m1500Histo02p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m1500_hadhad_03p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    //m2000 mass points
    histFileName = "run_XHH_bbtt_m2000_hadhad_01p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m2000Histo01p = (TH1D*)histFile->Get(histogramFile.c_str());
    m2000Histo01p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m2000_hadhad_02p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    TH1D* m2000Histo02p = (TH1D*)histFile->Get(histogramFile.c_str());
    m2000Histo02p->SetDirectory(0);
    histFile->Close();

    histFileName = "run_XHH_bbtt_m2000_hadhad_03p_5BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
