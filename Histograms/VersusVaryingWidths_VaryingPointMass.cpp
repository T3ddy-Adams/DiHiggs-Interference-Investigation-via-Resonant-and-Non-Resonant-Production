...
int VersusVaryingWidths_VaryingPointMass(std::string histogramFile){
    ...
    //m300 mass points
    histFileName = "run_XHH_bbtt_m300_hadhad_01p_2BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m300_hadhad_02p_2BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m500_hadhad_narrow_2BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    histFileName = "run_XHH_bbtt_m1500_hadhad_30p_2BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    histFileName = "run_XHH_bbtt_m1500_hadhad_narrow_2BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
