...
int VersusVaryingWidths_VaryingPointMass(std::string histogramFile){
    ...
    //m300 mass points
    histFileName = "run_XHH_bbtt_m300_hadhad_01p_10BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m300_hadhad_02p_10BSM_histogram.root";
    ...
    histFileName = "run_XHH_bbtt_m500_hadhad_narrow_10BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    histFileName = "run_XHH_bbtt_m1500_hadhad_30p_10BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
    ...
    histFileName = "run_XHH_bbtt_m1500_hadhad_narrow_10BSM_histogram.root";
    histFile = TFile::Open(histFileName.c_str(),"READ");
