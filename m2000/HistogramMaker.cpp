...
//to run:
    ...
    // root -l -q  "HistogramMaker.cpp(\"run_XHH_bbtt_m2000_hadhad_20p_nom\")" 
        // this will automatically quite root after running 
...
int HistogramMaker(std::string inFileName){
    ...
    // b particle data set
        ...
        //1-D plot
            // bb + tt to X
            TH1D bbtt_X_m("bb+tt->X_Mass","m_{bbtt->X}", 138, 240, 3000);  
            bbtt_X_m.Sumw2();
