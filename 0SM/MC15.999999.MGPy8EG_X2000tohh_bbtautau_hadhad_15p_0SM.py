...
#---------------------------------------------------------------------------------------------------
parameters={'1560':'2000', #MHH
            '1561':'300', #WHH
            '188':'0.0', #ctr (trilinear coupling, default 1.0)
            '189':'0.0', #cy (top Yukawa coupling, default 1.0)
            '190':'1.0',  #ctrH (hhH coupling, default 1.0)
            '191':'1.0'  #cyH (H Yukawa coupling, default 1.0)
            }
...
extras = { 'lhe_version':'2.0',
           ...
           'lhaid':'247000',
           'scale':'1000', #MHH/2
           'dsqrt_q2fact1':'1000', #MHH/2
           'dsqrt_q2fact2':'1000', #MHH/2      
